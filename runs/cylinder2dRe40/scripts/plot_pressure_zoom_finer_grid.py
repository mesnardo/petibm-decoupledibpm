...
label2 = r'500 markers ($\Delta s \approx \Delta x$)'
simudir2 = maindir / '500_markers_finer_grid'
...
ax2.scatter(*numpy.meshgrid(x2, y2), c='black', s=2, marker='o')
...
if args.save_figures:
    ...
    filepath = figdir / f'p_{timestep:0>7}_zoom_finer_grid.png'
